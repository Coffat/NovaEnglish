...
public class CoursePanel extends JPanel {
    ...
    public CoursePanel(com.languagecenter.ui.MainFrame mainFrame) {
    ...
    private void initUI() {
        ...
        String[] columns = { "ID", "Course Name", "Description", "Level", "Duration", "Fee", "Status", "Actions" };
        ...
        // Set custom comparator for Level column (index 3)
        sorter.setComparator(3, (Comparator<String>) (o1, o2) -> 
            Integer.compare(Course.getLevelWeight(o1), Course.getLevelWeight(o2))
        );
                            ...
                            if (course != null) {
                                if (mainFrame != null) {
                                    mainFrame.openCourseSidePanel(course, (updatedCourse) -> {
                                        ...
                                        JOptionPane.showMessageDialog(mainFrame, "Course updated successfully!");
                                    });
                                }
                            }
                        } else {
        ...
        btnAdd.addActionListener(e -> {
            if (mainFrame != null) {
                mainFrame.openCourseSidePanel(null, (newCourse) -> {
