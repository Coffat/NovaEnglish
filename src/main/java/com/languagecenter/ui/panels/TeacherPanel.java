...
public class TeacherPanel extends JPanel {
    ...
    public TeacherPanel(com.languagecenter.ui.MainFrame mainFrame) {
    ...
    private void initUI() {
        ...
        String[] columns = { "ID", "Full Name", "Specialty", "Hire Date", "Email", "Phone", "Status", "Actions" };
        ...
        // Setup Custom Renderers (Status=6, Actions=7)
                            ...
                            if (teacher != null) {
                                if (mainFrame != null) {
                                    mainFrame.openTeacherSidePanel(teacher, (updatedTeacher) -> {
                                        ...
                                        JOptionPane.showMessageDialog(mainFrame, "Teacher updated successfully!");
                                    });
                                }
                            }
                        } else {
        ...
        btnAdd.addActionListener(e -> {
            if (mainFrame != null) {
                mainFrame.openTeacherSidePanel(null, (newTeacher) -> {
