...
public class AttendancePanel extends JPanel {
    ...
    public AttendancePanel(com.languagecenter.ui.MainFrame mainFrame) {
    ...
    private void initUI() {
        ...
        String[] columns = {"ID", "Student", "Class", "Date", "Status", "Actions"};
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (row < table.getRowCount() && row >= 0 && column < table.getColumnCount() && column >= 0) {
                    if (table.getColumnName(column).equals("Actions")) {
                        ...
                        int attendanceId = (int) model.getValueAt(modelRow, 0);
                        ...
                        if (clickX < cellRect.width / 2) {
                            ...
                            if (attendance != null && mainFrame != null) {
                                mainFrame.openAttendanceSidePanel(attendance, (updatedAttendance) -> {
                                    attendanceDAO.updateAttendance(updatedAttendance);
                                    loadData();
                                    mainFrame.toggleSidePanel(false);
                                    JOptionPane.showMessageDialog(mainFrame, "Attendance updated successfully!");
                                });
                            }
                        } else {
                            // Delete
                            int confirm = JOptionPane.showConfirmDialog(AttendancePanel.this,
        ...
        btnAdd.addActionListener(e -> {
            if (mainFrame != null) {
                mainFrame.openAttendanceSidePanel(null, (newAttendance) -> {
                    attendanceDAO.addAttendance(newAttendance);
                    loadData();
                    mainFrame.toggleSidePanel(false);
                    JOptionPane.showMessageDialog(mainFrame, "Attendance recorded successfully!");
                });
            }
        });
    ...
    private void loadData() {
        ...
        for (Attendance a : attendances) {
            String studentName = a.getStudent() != null ? a.getStudent().getFullName() : "N/A";
            String className = a.getCourseClass() != null ? a.getCourseClass().getClassName() : "N/A";
    ...
    class StatusBadgeRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if (value != null) {
                ...
                if (value.toString().equalsIgnoreCase("Present")) {
                    badge.setForeground(new Color(0x15803D)); // Green
                    pill.setBackground(new Color(0xDCFCE7));
                    pill.setOpaque(true);
                } else if (value.toString().equalsIgnoreCase("Absent")) {
                    badge.setForeground(new Color(0xB91C1C)); // Red
                    pill.setBackground(new Color(0xFEE2E2));
                    pill.setOpaque(true);
                } else {
                    badge.setForeground(new Color(0xB45309)); // Yellow/Orange
